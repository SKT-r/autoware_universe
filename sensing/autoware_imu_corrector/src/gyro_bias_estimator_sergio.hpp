...
#ifndef GYRO_BIAS_ESTIMATOR_SERGIO_HPP_
#define GYRO_BIAS_ESTIMATOR_SERGIO_HPP_
...
{
class GyroBiasEstimatorSergio : public rclcpp::Node
{
private:
...
public:
  explicit GyroBiasEstimatorSergio(const rclcpp::NodeOptions & options);
...
#endif  // GYRO_BIAS_ESTIMATOR_SERGIO_HPP_