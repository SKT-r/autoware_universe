...
#include "autoware/imu_corrector/gyro_bias_estimator_sakata.hpp"
...
{
GyroBiasEstimatorSakata::GyroBiasEstimatorSakata(const rclcpp::NodeOptions & options)
: rclcpp::Node("gyro_bias_validator_sakata", options),
  ...
  is_vehicle_stopped_previous_(false),
  stopped_sample_count_(0)
{
  updater_.setHardwareID(get_name());
  updater_.add("gyro_bias_validator", this, &GyroBiasEstimatorSakata::update_diagnostics);
  ...
  twist_with_covariance_sub_ = create_subscription<geometry_msgs::msg::TwistWithCovarianceStamped>(
    ...
    std::bind(
      &GyroBiasEstimatorSakata::callback_twist_with_covariance, this, std::placeholders::_1));

  auto bound_timer_callback = std::bind(&GyroBiasEstimatorSakata::timer_callback, this);
...
void GyroBiasEstimatorSakata::callback_imu(const Imu::ConstSharedPtr imu_msg_ptr)
{
...
void GyroBiasEstimatorSakata::callback_odom(const Odometry::ConstSharedPtr odom_msg_ptr)
{
  // 車両停止状態の判定
  bool is_currently_stopped = is_vehicle_currently_stopped();
...
void GyroBiasEstimatorSakata::callback_twist_with_covariance(
...
// 新規追加：車両停止判定関数
bool GyroBiasEstimatorSakata::is_vehicle_currently_stopped()
{
...
void GyroBiasEstimatorSakata::timer_callback()
{
  if (pose_buf_.empty()) {
...
void GyroBiasEstimatorSakata::validate_gyro_bias()
{
...
geometry_msgs::msg::Vector3 GyroBiasEstimatorSakata::transform_vector3(
...
void GyroBiasEstimatorSakata::update_diagnostics(diagnostic_updater::DiagnosticStatusWrapper & stat)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::imu_corrector::GyroBiasEstimatorSakata)