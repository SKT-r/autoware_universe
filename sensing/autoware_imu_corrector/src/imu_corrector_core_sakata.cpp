...
#include "autoware/imu_corrector/imu_corrector_core_sakata.hpp"
...
std::array<double, 9> transform_covariance_sakata(const std::array<double, 9> & cov)
{
...
geometry_msgs::msg::Vector3 transform_vector3_sakata(
...
{
ImuCorrectorSakata::ImuCorrectorSakata(const rclcpp::NodeOptions & options)
: rclcpp::Node("imu_corrector_sakata", options),
...
void ImuCorrectorSakata::callback_imu(const sensor_msgs::msg::Imu::ConstSharedPtr imu_msg_ptr)
{
  ...
  imu_msg_base_link.linear_acceleration =
    transform_vector3_sakata(imu_msg.linear_acceleration, *tf_imu2base_ptr);
  imu_msg_base_link.linear_acceleration_covariance =
    transform_covariance_sakata(imu_msg.linear_acceleration_covariance);
  imu_msg_base_link.angular_velocity =
    transform_vector3_sakata(imu_msg.angular_velocity, *tf_imu2base_ptr);
  imu_msg_base_link.angular_velocity_covariance =
    transform_covariance_sakata(imu_msg.angular_velocity_covariance);
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::imu_corrector::ImuCorrectorSakata)