...
#ifndef GYRO_BIAS_ESTIMATOR_SAKATA_HPP_
#define GYRO_BIAS_ESTIMATOR_SAKATA_HPP_
...
{
class GyroBiasEstimatorSakata : public rclcpp::Node
{
private:
...
public:
  explicit GyroBiasEstimatorSakata(const rclcpp::NodeOptions & options);
...
#endif  // GYRO_BIAS_ESTIMATOR_SAKATA_HPP_